...
if($_REQUEST["noimage"]){
	$order=" ORDER BY employees.employee_ID asc";
	$noimage = " AND employees.PhotoPath IS NULL";
	}
...
if ($_REQUEST["from"]<>'' and $_REQUEST["to"]<>'') {
	...
	$order=" ORDER BY employees.rank asc, employees.employee_ID asc";
		$sql = "SELECT employees.employee_ID, employees.TitleOfCourtesy, employees.FirstName, employees.Middle_name, employees.LastName, employees.Position, employees.PhotoPath, department.dpt_name, section.section_name ".$add_years." FROM employees INNER JOIN department ON employees.department=department.id INNER JOIN section ON employees.section=section.id WHERE employees.apt_status is null".$noimage.$search_string.$search_city.$search_section.$search_rank.$order;
}
           ...
           <!-- /.box -->
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Employee List in Profile View</h3><br>
...
<div class="checkbox">
                      ...
                      <label>
                        <input type="checkbox" name="noimage"> No Profile Picture
                      </label>
