           ...
           <!-- /.box -->
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Employees that have Resigned</h3><br>
      ...
      <aside class="control-sidebar control-sidebar-dark">
        ...
        <!-- Tab panes -->
          ...
          <div class="tab-content tab-pane" id="control-sidebar-home-tab">
            <h3 class="control-sidebar-heading">Advance Filter Results</h3>
