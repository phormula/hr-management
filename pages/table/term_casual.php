...
<html>
  <head>
    ...
    <title>Terminated Casuals List</title>
           ...
           <!-- /.box -->
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Terminated Casuals</h3><br>
      ...
      <aside class="control-sidebar control-sidebar-dark">
        ...
        <!-- Tab panes -->
          ...
          <div class="tab-content tab-pane" id="control-sidebar-home-tab">
            <h3 class="control-sidebar-heading">Advance Filter Employees</h3>
