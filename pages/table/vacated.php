...
<html>
  <head>
    ...
    <title>List of Vacated Appointments<?php if(!empty($title)){echo $title;} ?></title>
           ...
           <!-- /.box -->
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Employees with Vacated Appointments</h3><br>
