...
try {
   ...
   // echo 'Connected to database<br />';
    ...
    /*** INSERT data ***/
    $count = $dbh->exec("INSERT INTO employees (`employee_ID`, `TitleOfCourtesy`, `FirstName`, `Middle_name`, `LastName`, `phone`, `email`, `department`, `section`, `rank`, `Position`, `BirthDate`, `HireDate`, `Address`, `ReportsTo`) VALUES('$emp_id', '$toc', '$fname', '$mname', '$lname', '$phone', '$email_address', '$department', '$section', '$rank', '$position', '$dob', '$apd', '$address', '$report') ");
...
$date->add($interval);
   ...
   // echo 'Connected to database<br />';
    ...
    /*** INSERT data ***/
    $count = $dbh->exec("INSERT INTO `contracts`(`employee_ID`, `starting_date`, `due_date`) VALUES('$emp_id',  '$apd','".$date->format('Y-m-d')."') ");
...
try {
   ...
   // echo 'Connected to database<br />';
    ...
    /*** INSERT data ***/
    $count = $dbh->exec("INSERT INTO employees (`employee_ID`, `TitleOfCourtesy`, `FirstName`, `Middle_name`, `LastName`, `phone`, `email`, `department`, `section`, `rank`, `Position`, `BirthDate`, `HireDate`, `Address`, `ReportsTo`, `PhotoPath`) VALUES('$emp_id', '$toc', '$fname', '$mname', '$lname', '$phone', '$email_address', '$department', '$section', '$rank', '$position', '$dob', '$apd', '$address', '$report', '$thumb_path') ");
