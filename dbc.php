...
$company_name = "Piccadilly Biscuits Ltd";

define ("DB_HOST", "localhost"); // set database host
define ("DB_USER", "phormula"); // set database user
define ("DB_PASS","11emaths"); // set database password
define ("DB_NAME","emaleck2"); // set database name
...
if (!isset($_SESSION['user_id']) && !isset($_SESSION['user_name']) ) 
{
	...
	// coookie expiry
	if( (time() - $ctime) > 60*5*COOKIE_TIME_OUT) {
